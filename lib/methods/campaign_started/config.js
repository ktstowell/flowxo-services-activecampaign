...
var config = {
  ...
  fields: {
    ...
    output: [
      ...
      {
        key: 'lists',
        label: 'Lists campaign was sent to'
      },
      {
        key: 'campaign__name',
  ...
  help: {
    webhook: {
      ...
      test: [
        'Create a sample campaign to a personal email. Start the campaign and you should see your flowxo integration update with the webhooks'
      ]
    }
  }
};
